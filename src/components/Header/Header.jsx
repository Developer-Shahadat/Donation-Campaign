...
const Header = () => {
    ...
    <div className="mt-10">
        <input className="border-2 p-2 w-1/4 ml-96 " type="text" name="text" placeholder="search" />
        <button className="p-2 pl-4 pr-4 bg-[#FF444A] text-white font-semibold">Search</button>
    </div>
</header>
        </div>
    );
