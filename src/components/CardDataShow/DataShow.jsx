...
const DataShow = ({loader}) => {
    ...
    return (
        ...
        <div className='mt-10'>
            ...
            <div className="card bg-base-100 md:mx-4 shadow-xl rounded-lg">
                <figure><img src={img} /></figure>
                <div style={{backgroundColor: card_bg_color}} className="card-body md:none md:mx-0 lg:mx-0 lg:none block  mx-14">
